...
frappe.provide('jmi_erpnext.email');

jmi_erpnext.email.CommunicationComposer = Class.extend({
	init: function(opts) {
		$.extend(this, opts);
		this.make();
	},
	make: function() {
		console.log("JMI Email Composer");  // Helps verify we're calling the correct composer.
		var me = this;
